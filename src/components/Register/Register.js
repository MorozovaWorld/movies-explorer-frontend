  ...
  return (
    <FormPage title='Добро пожаловать!' btnText="Зарегистрироваться" linkText="Войти" linkReason="Уже зарегистрированы?" linkUrl="/signin">
      <div className="formPage__input-container">
        ...
        <input type="text" onChange={handleChange} name='name' value={userData.name} id="user-name" className="formPage__input-text" placeholder="Введите имя" autoComplete='off' required />
      ...
      <div className="formPage__input-container">
        ...
        <input type="email" onChange={handleChange} placeholder="Введите e-mail" name='email' value={userData.email} id="user-email" className="formPage__input-text" autoComplete='off' required />
